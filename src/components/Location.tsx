    ...
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
              ...
              >
                ...
                >
                  {countriesLoading
                    ? 'Loading...'
                    : field.value
                      ? //@ts-expect-error TODO:need to fix ts error
        ...
        <div className="mb-4">
          ...
          <Controller
            ...
            render={({ field }) => (
              <Select
                ...
                value={field.value}
                disabled={
                  !selectedCountry || citiesLoading || citiesError || !cities
                }
              >
                <SelectTrigger
                  className={clsx(
          ...
          />
          {citiesError && (
            <p className="text-red-500 text-sm mt-1">Failed to load cities.</p>
          )}
          {errors.city && (
