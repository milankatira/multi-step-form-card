    ...
    <div className="max-w-2xl mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <Card className="mb-6">
        <CardHeader className="flex justify-between items-center">
          ...
          <Button variant="secondary" onClick={() => handleEdit('personal')}>
            Edit
          </Button>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mb-6">
        <CardHeader className="flex justify-between items-center">
          ...
          <Button variant="secondary" onClick={() => handleEdit('location')}>
            Edit
          </Button>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mb-6">
        <CardHeader className="flex justify-between items-center">
          ...
          <Button variant="secondary" onClick={() => handleEdit('payment')}>
            Edit
          </Button>
        </CardHeader>
        <CardContent>
